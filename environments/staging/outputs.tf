# =============================================================================
# Outputs — Use these values to update your K8s manifests
# =============================================================================
...
output "public_subnet_ids" {
  description = "Use these in your ALB ingress annotation: alb.ingress.kubernetes.io/subnets"
...
# RDS
output "rds_endpoint" {
  description = "Update POSTGRES_HOST_* in your configmaps with this value"
...
output "kafka_bootstrap_brokers" {
  description = "Update KAFKA_BROKERS in your secrets with this value"
  value       = module.kafka.bootstrap_brokers
}

# Bastion
output "bastion_public_ip" {
  description = "Update your DBeaver SSH tunnel host with this IP"
...
output "ecr_repository_urls" {
  description = "Update your CI/CD image push targets"
